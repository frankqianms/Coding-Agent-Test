 ...
 * and demonstrates a basic for loop with output.
 * 
 * @author Coding Agent
 * @version 1.0
 */
...
public class Main {
     ...
     * 
     * This method executes when the program starts. It prints a welcome message
     * and then iterates through numbers 1-5, printing each value.
     * 
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            // Output the current iteration value
